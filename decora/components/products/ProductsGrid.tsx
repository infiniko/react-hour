import { Product } from "@/lib/generated/client/client";
        ...
        return (
          <article key={productId} className="group relative">
            <Link href={`/products/${productId}`}>
              <Card className="transform group-hover:shadow-xl transition-shadow duration-500 py-4">
            ...
            <div className="absolute top-10 right-6 z-5">
              <FavoriteToggleButton productId={productId} layout="grid" />
            </div>
          </article>
        );
      })}
