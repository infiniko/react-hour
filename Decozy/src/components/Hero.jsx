    ...
    <div className="grid lg:grid-cols-2 gap-24 items-center">
      <div>
        <h1 className="max-w-2xl text-2xl font-bold tracking-tight sm:text-6xl">
          Style Your Space. Live Better.
        </h1>
        <p className="mt-8 max-w-xl text-lg leading-8">
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Error soluta
          perferendis esse tempore illo dolor? Odit, asperiores in corporis
          error vero, ex commodi qui voluptates doloribus fugit exercitationem
          nam ipsum.
        </p>
        <div className="mt-10">
